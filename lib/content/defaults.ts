...
export const DEFAULT_HOME: HomeContent = {
  hero: {
    ...
    description:
      '철골 · 지붕 · 벽체부터 배관 수리, 탱크 용접, 장비 수리, 그리고 반도체 공장의 크린룸 · 방음 · 공압 · 냉각수 배관까지. 공장에서 생기는 문제는 무엇이든 맡겨 주세요. 공종마다 업체를 따로 찾을 필요 없이, 진단부터 마감까지 편하게 해결해 드립니다.',
    primaryCta: '빠른 견적 받기',
  ...
  items: [
    {
      ...
      areasDescription:
        '반도체와 협력사 공장은 청정도, 진동, 온도, 유틸리티 공급 중 하나만 흔들려도 라인이 멈춥니다. 공장 개보수부터 크린룸, 방음, 공압, 냉각수, 배관설비까지 모두 시공 가능하니 공종별로 업체를 따로 찾지 않으셔도 됩니다. 가동 중인 라인은 셧다운 일정에 맞춰 구간별로 진행하고, 현장 반입 절차와 안전 기준을 먼저 확인한 뒤 들어갑니다.',
