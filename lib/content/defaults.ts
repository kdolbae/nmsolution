...
export const DEFAULT_HOME: HomeContent = {
  hero: {
    ...
    description:
      '철골 · 지붕 · 벽체부터 장비 수리, 방음 · 흡음, 크린룸, 공압 · 배관 설비까지. 공장에서 생기는 문제는 부위별로 업체를 나눠 부르지 않아도 됩니다. 진단부터 마감까지 한 팀이 맡습니다.',
    primaryCta: '빠른 견적 받기',
    ...
    ticker: ['철골 · 지붕', '벽체 · 판넬', '바닥 · 단열', '방음 · 흡음', '크린룸', '공압 · 배관', '장비 수리'],
  },
  scope: {
    kicker: 'Scope of Work',
    title: '공장 안에서 생기는 문제는\n전부 저희 일입니다.',
    description:
      '철골 · 지붕 · 벽체 같은 건축 공사부터 공압 · 배관 설비, 생산 장비 수리, 방음 · 흡음, 크린룸까지. 지붕 한 구간의 누수도, 공장 전체 리뉴얼도 한 곳에서 끝냅니다.',
    items: [
      {
        n: '01',
        title: '철골 · 지붕 · 벽체',
        description:
          '철골 보강과 교체, 노후 판넬·누수 지붕 보수, 외벽·벽체 마감과 실링. 공장 건물의 골격과 외피를 함께 봅니다.',
      ...
      },
      {
        ...
        title: '설비 · 배관 · 장비',
        description:
          '공압설비·배관설비 신설, 노후 배관 수리와 교체, 생산 장비 정비. 압력 손실과 누수는 증상만 막지 않고 원인부터 찾습니다.',
  ...
  why: {
    ...
    items: [
      ...
      { en: 'PROFESSIONAL', ko: '전문적으로', description: '건축·설비·장비 각 공정의 기준을 알고, 증상이 아니라 원인부터 확인하고 시공합니다.' },
  ...
  items: [
    {
      ...
      summary: '철골·지붕·벽체부터 설비·배관, 장비 수리, 크린룸까지 한 팀이.',
      description:
        '공장에서 생기는 수리는 범위를 나누지 않습니다. 철골 보강과 지붕·외벽 판넬 교체, 바닥 재시공, 내부 단열 같은 건축 공사부터 공압·배관 설비, 생산 장비 수리, 방음·흡음, 크린룸 구축까지 함께 진행합니다. 생산 일정에 맞춰 구간을 나눠 시공하고, 현장 진단 후 항목별로 명확한 견적을 제시합니다.',
